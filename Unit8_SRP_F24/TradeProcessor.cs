...
namespace SingleResponsibilityPrinciple
{
    public class TradeProcessor
    {
        ...
        private void StoreTrades(IEnumerable<TradeRecord> trades)
        {
            ...
            string daveConnectString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\jobst\Documents\tradedatabase.mdf;Integrated Security=True;Connect Timeout=30";

            // Change the connection string used to match the one you want
            using (var connection = new SqlConnection(daveConnectString))
            {
